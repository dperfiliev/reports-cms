...
export interface ApiGuberGuber extends Schema.CollectionType {
...
export interface ApiTextTypeTextType extends Schema.CollectionType {
  collectionName: 'text_types';
  info: {
    singularName: 'text-type';
    pluralName: 'text-types';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::guber.guber': ApiGuberGuber;
      'api::period.period': ApiPeriodPeriod;
      'api::report.report': ApiReportReport;
      'api::source.source': ApiSourceSource;
      'api::text-type.text-type': ApiTextTypeTextType;
    }
  }
}
